...
function RatingCard({
  ...
  return (
    <div
      className="glass rounded-2xl overflow-hidden group cursor-pointer hover:border-opacity-20 transition-all duration-200"
      style={{ border: "1px solid var(--border)" }}
    >
      {/* Album art */}
      <div
  ...
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(160deg, rgba(88,28,135,0.55) 0%, rgba(49,10,80,0.4) 40%, rgba(8,8,8,0) 100%)",
      ...
      >
        ...
        <div
          ...
          style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 24px 40px" }}
        >
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex items-end gap-5">
              ...
              <div>
                <div className="flex items-center gap-2.5 flex-wrap">
                  <h1
                    style={{ color: "var(--text-primary)", fontSize: 26, fontWeight: 700, letterSpacing: "-0.02em" }}
                  >
                    Joel Newton
                  </h1>
                  {/* Spotify badge */}
            ...
            <div className="flex items-center gap-2.5">
              ...
              <button
                className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-150 hover:opacity-70"
                style={{
                  border: "none",
        ...
        <div className="flex flex-col gap-12">
          ...
          <section className="animate-fade-in-up" style={{ animationDelay: "0.05s" }}>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2
                style={{ color: "var(--text-primary)", fontSize: 20, fontWeight: 700, letterSpacing: "-0.01em" }}
              >
                Your Taste DNA
              </h2>
              <span
            ...
            >
              ...
              <div
                ...
                style={{ border: "1px solid var(--border)" }}
              >
                <p style={{ color: "var(--text-muted)", fontSize: 11, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 20 }}>
                  Genre Breakdown
                </p>
                <div className="flex flex-col gap-3.5">
                  {genres.map((g) => (
                    <GenreBar key={g.name} name={g.name} pct={g.pct} color={g.color} />
                  ))}
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <p style={{ color: "var(--text-muted)", fontSize: 11, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 4 }}>
                  Musical Personality
                </p>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                  {traits.map((t) => (
                    <TraitCard key={t.label} label={t.label} pct={t.pct} desc={t.desc} />
                  ))}
                </div>
              </div>
            </div>
            ...
            >
              {friendRecs.map((rec) => (
                <FriendRecCard
                  ...
                  album={rec.album}
                  artist={rec.artist}
                  albumGradient={rec.albumGradient}
                  albumInitials={rec.albumInitials}
                  note={rec.note}
                />
              ))}
            </div>
