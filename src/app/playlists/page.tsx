...
export const metadata: Metadata = {
  title: "Playlists — RMM.AI",
  description: "Browse your AI-generated playlists and playlists synced from Spotify.",
};
...
function MosaicArt({
  ...
  return (
    ...
    >
      {colors.slice(0, 4).map((color, colorPos) => (
        <div
          key={`mosaic-${color}-${colorPos}`}
          style={{
            width: squareSize,
            height: squareSize,
...
function AiPlaylistsSection() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      <SectionHeader icon={Sparkles} title="AI Generated Playlists" subtitle="Built from your listening DNA" />
        ...
        {aiPlaylists.map((playlist) => (
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
              <h3 style={{ fontSize: "1rem", fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.015em" }}>
                {playlist.name}
              </h3>
              <p
                style={{
...
function SpotifyPlaylistsSection() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <SectionHeader icon={ListMusic} title="Your Playlists from Spotify" subtitle="Synced from Spotify" />
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#22c55e", boxShadow: "0 0 6px rgba(34, 197, 94, 0.6)" }} />
          <span style={{ fontSize: "0.72rem", color: "var(--text-muted)", fontWeight: 500 }}>Synced 3 min ago</span>
        </div>
      </div>
...
function FriendPlaylistsSection() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      <SectionHeader icon={Music2} title="Friends' Playlists" subtitle="Shared by friends" />
